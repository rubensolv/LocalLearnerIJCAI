...
public class ImprovedStrategyTactics extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public AI clone() {        
        try {
            return new ImprovedStrategyTactics(new UnitTypeTable(), weightStrategy, weightTactics, strategyAI, tacticsAI, decay_base);
        } catch (Exception ex) {
            Logger.getLogger(ImprovedStrategyTactics.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
