 ...
 * @author rubens
 */
public class EconomyRushBase extends AbstractionLayerAI {
    ...
    public EconomyRushBase(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }

    public EconomyRushBase(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
...
//        System.out.println("LightRushAI for player " + player + " (cycle " + gs.getTime() + ")");
    ...
    @Override
    public AI clone() {
        return new EconomyRushBase(utt, pf);
    }
    
    @Override
    public AI clone_for_Thread() {
        return new EconomyRushBase(utt, new AStarPathFinding());
    }
