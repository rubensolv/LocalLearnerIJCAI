 ...
 * @author santi
 */
public class HeavyRushBase extends AbstractionLayerAI {
    ...
    public HeavyRushBase(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }


    public HeavyRushBase(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
    ...
    public AI clone() {
        return new HeavyRushBase(utt, pf);
    }
    
    @Override
    public AI clone_for_Thread() {
        return new HeavyRushBase(utt, new AStarPathFinding());
    }
