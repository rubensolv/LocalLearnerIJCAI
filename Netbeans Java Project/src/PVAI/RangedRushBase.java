 ...
 * @author santi
 */
public class RangedRushBase extends AbstractionLayerAI {
    ...
    public RangedRushBase(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }


    public RangedRushBase(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
    ...
    public AI clone() {
        return new RangedRushBase(utt, pf);
    }
    
    @Override
    public AI clone_for_Thread() {
        return new RangedRushBase(utt, new AStarPathFinding());
    }
