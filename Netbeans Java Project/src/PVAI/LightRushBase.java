 ...
 * @author santi
 */
public class LightRushBase extends AbstractionLayerAI {
    ...
    public LightRushBase(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }


    public LightRushBase(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
    ...
    public AI clone() {
        return new LightRushBase(utt, pf);
    }

    @Override
    public AI clone_for_Thread() {
        return new LightRushBase(utt, new AStarPathFinding());
    }
