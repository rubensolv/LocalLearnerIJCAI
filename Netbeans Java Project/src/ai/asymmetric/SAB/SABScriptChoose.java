...
public class SABScriptChoose extends AIWithComputationBudget implements InterruptibleAI {
    ...
    //statistics
    Integer qtdActions = 0;
    Integer qtdresets = 0;
    boolean withUsed = false;
...
//                System.out.println("Escolhido paAB");
//            }else{
//                System.out.println("Escolhido paSSS");
//            }
    ...
    public void printAsymmetricUseStatistics(){
        //System.out.println("------------------------------------");
        //System.out.println("Total of Actions "+ this.qtdActions);
        //System.out.println("Total of Resets  "+ this.qtdresets);
        //System.out.println("Total of Within-Used "+ (this.qtdActions-this.qtdresets));
        //System.out.println("------------------------------------");
        System.out.println(this.qtdActions+";"+this.qtdresets+";"+(this.qtdActions-this.qtdresets));
    }
    
    public String getAsymmetricUseStatistics(){
        //System.out.println("------------------------------------");
       // System.out.println("Total of Actions "+ this.qtdActions);
        ///System.out.println("Total of Resets  "+ this.qtdresets);
        //System.out.println("Total of Within-Used "+ (this.qtdActions-this.qtdresets));
        //System.out.println("------------------------------------");
        return this.qtdActions+";"+this.qtdresets+";"+(this.qtdActions-this.qtdresets);
    }
