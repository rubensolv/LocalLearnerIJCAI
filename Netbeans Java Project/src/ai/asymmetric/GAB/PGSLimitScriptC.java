 ...
 * @author rubens
 */
public class PGSLimitScriptC extends AIWithComputationBudget implements InterruptibleAI{
    ...
    public PGSLimitScriptC(UnitTypeTable utt) {
        this(100, -1, 200, 1, 1, 
    ...
    public PGSLimitScriptC(UnitTypeTable utt, List<AI> scripts) {
        this(100, -1, 200, 1, 1, 
             new SimpleSqrtEvaluationFunction3(),
             //new SimpleSqrtEvaluationFunction2(),
             //new LanchesterEvaluationFunction(),
    ...
    public PGSLimitScriptC(int time, int max_playouts, int la, int a_I, int a_R, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf) {
    ...
    */
    ...
    @Override
    public AI clone() {
        return new PGSLimitScriptC(TIME_BUDGET, ITERATIONS_BUDGET, LOOKAHEAD, I, R, evaluation, utt, pf);
    }
