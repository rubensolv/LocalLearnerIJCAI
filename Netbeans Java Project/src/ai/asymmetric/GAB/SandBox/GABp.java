 ...
 * @author rubens
 */
public class GABp extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public GABp(UnitTypeTable utt, int numUnits, int numManager) {
        this(100, 200, new SimpleSqrtEvaluationFunction3(), utt, new AStarPathFinding(), numUnits, numManager);
    }
    
    public GABp(UnitTypeTable utt, int numUnits, int numManager, List<AI> IAsPort, String name) {
        this(100, 200, new SimpleSqrtEvaluationFunction3(), utt, new AStarPathFinding(), numUnits, numManager);
        this.name = name;
        this._pgs.setNewPortfolio(IAsPort);
    }
    
    public GABp(UnitTypeTable utt, int max_playouts, int numUnits, int numManager, List<AI> IAsPort, String name) {
        this(100, max_playouts, new SimpleSqrtEvaluationFunction3(), utt, new AStarPathFinding(), numUnits, numManager);
        this.name = name;
        this._pgs.setNewPortfolio(IAsPort);
    }
    
    public GABp(UnitTypeTable utt, int numUnits, int numManager, List<AI> IAsPort, List<AI> IAsABCD,String name) {
        this(100, 200, new SimpleSqrtEvaluationFunction3(), utt, new AStarPathFinding(), numUnits, numManager);
        this.name = name;
        this._pgs.setNewPortfolio(IAsPort);
    ...
    public GABp(int time, int max_playouts, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf) {
    ...
    public GABp(int time, int max_playouts, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf, int numUnits, int numManager) {
        super(time, max_playouts);
    ...
    @Override
    public AI clone() {
        return new GABp(_time, _max_playouts, evaluation, utt, pf);
    }
    ...
    public String toString() {
        ...
        return "GABp" +"_" +_numUnits + "_" + _numManager;
        //return "GABp";
        //return name;
    }
