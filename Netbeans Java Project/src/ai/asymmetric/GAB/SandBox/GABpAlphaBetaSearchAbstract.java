 ...
 * @author rubens
 */
public class GABpAlphaBetaSearchAbstract extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public GABpAlphaBetaSearchAbstract(UnitTypeTable utt) {
        this(100, 100, new AlphaBetaSearchParameters(), new TranspositionTable(), utt);
    }

    public GABpAlphaBetaSearchAbstract(int time, int max_playouts, AlphaBetaSearchParameters _params, TranspositionTable _TT, UnitTypeTable utt) {
        ...
        _params.setOrderedMoveScripts(new ArrayList<AI>() {
            {
                ...
                add(0, scriptsCompleteSet.get(3));
                add(1, scriptsCompleteSet.get(2));
                add(2, scriptsCompleteSet.get(1));
                add(3, scriptsCompleteSet.get(0));
    ...
    public GABpAlphaBetaSearchAbstract(int time, int max_playouts, AlphaBetaSearchParameters _params, TranspositionTable _TT) {
        super(time, max_playouts);
    ...
    private MoveArrayAbstract generateMoves(MoveArrayAbstract moves, Players playerToMove, GameState state) throws Exception {
        ...
        try {
            ...
            Logger.getLogger(GABpAlphaBetaSearchAbstract.class.getName()).log(Level.SEVERE, null, ex);
    ...
    @Override
    public AI clone() {
        return new GABpAlphaBetaSearchAbstract(TIME_BUDGET, ITERATIONS_BUDGET, _params, _TT);
    }
