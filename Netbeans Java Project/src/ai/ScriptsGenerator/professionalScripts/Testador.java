...
public class Testador {
    ...
    public static void main(String args[]) throws Exception {
        ...
        PhysicalGameState pgs = PhysicalGameState.load("maps/16x16/16x16Barreiras.xml", utt);        
        ...
        AI ai1 = new botEmptyBase(utt, "build(Barrack,1,Right)\n" +
" harvest(1)\n" +
" train(Ranged,5,EnemyDir)\n" +
" if(IsPlayerInPosition(Left)) (moveToCoord(Ranged,6,4))\n" +
" if(IsPlayerInPosition(Left)) (moveToCoord(Ranged,5,5))\n" +
" if(IsPlayerInPosition(Left)) (moveToCoord(Ranged,4,6))\n" +
" if(IsPlayerInPosition(Left)) (moveToCoord(Ranged,3,7))", "Teste");
