 ...
 * @author rubens
 */
public class A3NWithinGenerator implements ICMAB_ActionGenerator{
    ...
    public A3NWithinGenerator( GameState gs_to_start_from, int playerForThisComputation, UnitTypeTable a_utt, String Behavior, int qtdUNits, List<AI> abstraction) throws Exception{
        ...
        for (Unit u : gs_to_start_from.getUnits()) {
            if (u.getPlayer() == playerForThisComputation && !unitsControled.contains(u)) {
                if (gs_to_start_from.getUnitActions().get(u) == null) {
                    ...
                    if (l.isEmpty()) {
                        l.add(u.getUnitActions(gs_to_start_from).get(0));
                    }
