...
public class CmabAssymetricMCTS extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public AI clone_for_Thread() {
        return new CmabAssymetricMCTS(TIME_BUDGET, ITERATIONS_BUDGET, MAXSIMULATIONTIME, MAX_TREE_DEPTH, epsilon_l, discount_l, epsilon_g, discount_g, epsilon_0, discount_0, playoutPolicy.clone_for_Thread(), ef, forceExplorationOfNonSampledActions);
    }
